...
Para ello, utilizaremos la base de datos de la cuarta ola del Estudio Longitudinal Social de Chile 2019 con el objetivo de analizar agrupaciones de variables categóricas nominales.

## Preparación de los datos

Antes de comenzar, prepararemos nuestros datos. Inicioamos cargando las librerias necesarias.
...
elsoc_long_2016_2022.2: dataset longitudinal de ELSOC.

filter(ola=="4"): selecciona solo la ola 4 (cuarta medición de la encuesta).

select(educacion=m01, aut_demo=c25):
...
[Ver tabla de contingencia](practicos/tabla_contingencia.html)
...
[Ver tabla de contingencia](practicos/tabla_contingenciapor.html)
...
[Ver tabla de contingencia](practicos/chicuadrado.html)
