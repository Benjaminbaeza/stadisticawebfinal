...
📋 Tabla 1: Variables utilizadas - Módulo de cohesión territorial (ELSOC) - Escala Likert 1-4
</caption>
<thead>
...
<td style="border: 1px solid #ddd; padding: 14px; text-align: center;"><span style="background-color: #e0e0e0; padding: 4px 8px; border-radius: 12px;">1-4</span></td>
</tr>
...
<strong>Nota:</strong> Todas las variables son de escala ordinal tipo Likert (1=Totalmente en desacuerdo a 4=Totalmente de acuerdo). Estas variables provienen del módulo de cohesión territorial de la encuesta ELSOC.
</td>
</tr>
</tfoot>
</table>
